...
@protocol SKAnimatedImageViewDebugDelegate;


//
//  An `SKAnimatedImageView` can take an `SKAnimatedImage` and plays it automatically when in view hierarchy and stops when removed.
...
//
@interface SKAnimatedImageView : UIImageView
...
@property (nonatomic, strong) SKAnimatedImage *animatedImage;
